...
export const getSpecifityFilm = () => async(dispatch) => {
    getFilm(apiService.GetSpecifityFilm, dispatch, FILMSPREVIEWS_GET_SPECIFICITY_FILM_REQUEST,
        FILMSPREVIEWS_GET_SPECIFICITY_FILM_SUCCSESS, FILMSPREVIEWS_GET_SPECIFICITY_FILM_FAIL);
};

export const getRandomFilm = () => async(dispatch) => {
    getFilm(apiService.GetRandomFilm, dispatch, FILMSPREVIEWS_GET_RANDOM_FILM_REQUEST,
